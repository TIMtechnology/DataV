(function (global, factory) {
  ...
  lib$4.toRgb;
  lib$4.toHex;
  lib$4.getColorFromRgbValue;
  lib$4.darken;
  lib$4.lighten;
  var lib_9 = lib$4.fade;
  ...
  Style.prototype.colorProcessor = function (style) {
    ...
    var processor = reverse ? lib$4.getColorFromRgbValue : lib$4.getRgbaValue;
  ...
  function initGraphStyle(ctx, style) {
    ...
    ctx.fillStyle = (0, lib$4.getColorFromRgbValue)(fill);
    ctx.strokeStyle = (0, lib$4.getColorFromRgbValue)(stroke);
    ctx.shadowColor = (0, lib$4.getColorFromRgbValue)(shadowColor);
  ...
  function initGradient(ctx, style) {
    ...
    gradientColor = gradientColor.map(function (c) {
      return (0, lib$4.getColorFromRgbValue)(c);
    });
  ...
  var _color = interopRequireDefault(lib$4);
  ...
  var agArc = {
    ...
    draw: function draw(_ref5, _ref6) {
      ...
      gradient = gradient.map(function (cv) {
        return (0, lib$4.getColorFromRgbValue)(cv);
      });
  ...
  function getRadarStyle(radarItem) {
    ...
    var colorRgbaValue = (0, lib$4.getRgbaValue)(color);
    colorRgbaValue[3] = 0.5;
    var radarDefaultColor = {
      stroke: color,
      fill: (0, lib$4.getColorFromRgbValue)(colorRgbaValue)
    };
